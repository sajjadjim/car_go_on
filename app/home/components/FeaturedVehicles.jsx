    ...
    <section className="py-16 px-4 bg-slate-950 border-b border-slate-800">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">
              Verified Stock in Bangladesh
            </div>
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight">
              Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-200">Cars & Bikes</span>
            </h2>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-xl border border-slate-800 bg-slate-900 text-xs font-semibold text-slate-300 hover:text-white hover:border-slate-700 transition"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {displayCars.map((car) => {
              ...
              return (
                <div
                  key={id}
                  className="group rounded-2xl overflow-hidden border border-slate-800 bg-slate-900/60 hover:bg-slate-900 transition-all duration-300 hover:border-amber-400/40 hover:shadow-2xl hover:shadow-amber-500/10 flex flex-col justify-between"
                >
                  <div>
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2 text-xs">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/60">
                          <FaGasPump className="text-amber-400 text-[10px]" />
                          {car.fuel_type || "Petrol"}
                        </span>
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/60">
                          <FaCogs className="text-sky-400 text-[10px]" />
                  ...
                  <div className="p-5 pt-0">
                    <Link
                      href={`/cars/${id}`}
                      className="block w-full text-center py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-300 hover:to-yellow-400 text-slate-950 transition"
                    >
                      View Details & Specs →
                    </Link>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {displayBikes.map((bike) => {
              ...
              return (
                <div
                  key={id}
                  className="group rounded-2xl overflow-hidden border border-slate-800 bg-slate-900/60 hover:bg-slate-900 transition-all duration-300 hover:border-emerald-500/40 hover:shadow-2xl hover:shadow-emerald-500/10 flex flex-col justify-between"
                >
                  <div>
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2 text-xs">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/60">
                          <FaCogs className="text-emerald-400 text-[10px]" />
                          {bike.engine_cc} cc
                        </span>
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-800/80 text-slate-300 border border-slate-700/60">
                  ...
                  <div className="p-5 pt-0">
                    <Link
                      href={`/bikes/${id}`}
                      className="block w-full text-center py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-slate-950 transition"
                    >
                      View Details & Specs →
                    </Link>
                  </div>
