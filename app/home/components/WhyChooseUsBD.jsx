      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight">
            How CarGoON Works in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-200">Bangladesh</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, idx) => (
            <div
              key={idx}
              className="p-6 rounded-3xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 hover:bg-slate-900 transition-all duration-300 relative group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="font-mono text-2xl font-black text-slate-700 group-hover:text-amber-400/40 transition-colors">
                    {s.step}
                  </span>
                </div>
        ...
        {/* Action CTAs */}
        <div className="mt-14 p-8 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-2xl font-bold text-white">Have a car or motorcycle to sell?</h3>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link
              href="/addCar"
              className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-300 hover:to-yellow-400 text-slate-950 font-bold text-sm shadow-lg shadow-amber-400/20 transition"
            >
