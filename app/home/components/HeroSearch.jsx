...
export default function HeroSearch() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border-b border-slate-800/80 pt-16 pb-20 px-4">
      {/* Background Glows */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-slate-800 text-xs font-semibold text-slate-300 shadow-xl mb-4 backdrop-blur">
            <span className="flex h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-amber-400 font-bold">Bangladesh’s Premier</span> Vehicle Marketplace
            <span className="text-slate-600">•</span>
            <span className="text-emerald-400">Cars & Bikes</span>
          </div>
        ...
        <div className="mt-10 max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="inline-flex p-1.5 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-xl backdrop-blur">
              <button
                type="button"
                onClick={() => {
                  setVehicleType("car");
            ...
            <Link
              href="/addCar"
              className="hidden sm:inline-flex items-center gap-2 text-xs font-bold text-amber-400 hover:text-amber-300 transition"
            >
          ...
          <form
            ...
            className="p-4 sm:p-5 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-2xl backdrop-blur-xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3"
          >
            {/* Keyword Input */}
            <div className="lg:col-span-4 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3.5 py-3 rounded-2xl bg-slate-950 border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:border-amber-400 text-sm transition"
              />
            </div>
            ...
            <div className="lg:col-span-3">
              <select
                ...
                className="w-full px-3.5 py-3 rounded-2xl bg-slate-950 border border-slate-800 text-white focus:outline-none focus:border-amber-400 text-sm transition"
              >
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2 text-xs">
            <span className="text-slate-500">Popular in BD:</span>
            <Link
              href="/cars?search=Premio"
              className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 hover:border-amber-400/50 hover:text-amber-300 transition"
            >
              Toyota Premio (৳32-36L)
            </Link>
            <Link
              href="/bikes?search=R15"
              className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 hover:border-emerald-400/50 hover:text-emerald-300 transition"
            >
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/80 flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-white">Realistic BD Market Prices</h4>
              <p className="text-xs text-slate-400 mt-0.5">Updated prices in ৳ Lakh & Crore</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/80 flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-white">Bikes & Scooters Section</h4>
              <p className="text-xs text-slate-400 mt-0.5">Yamaha, Royal Enfield, Suzuki & more</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/80 flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-white">BRTA Paperwork Status</h4>
              <p className="text-xs text-slate-400 mt-0.5">Registration, Smart Card & Tax Token</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/80 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Call or WhatsApp without middlemen</p>
            </div>
          </div>
        </div>
      </div>
